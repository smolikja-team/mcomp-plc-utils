...
$PlcDtBOCopyWith<PlcDtBO> get copyWith => _$PlcDtBOCopyWithImpl<PlcDtBO>(this as PlcDtBO, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PlcDtBO&&(identical(other.value, value) || other.value == value)&&(identical(other.dt, dt) || other.dt == dt));
}
...
abstract mixin class $PlcDtBOCopyWith<$Res>  {
  factory $PlcDtBOCopyWith(PlcDtBO value, $Res Function(PlcDtBO) _then) = _$PlcDtBOCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$PlcDtBOCopyWithImpl<$Res>
    implements $PlcDtBOCopyWith<$Res> {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PlcDtBO value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PlcDtBO value)  $default,){
final _that = this;
switch (_that) {
case _PlcDtBO():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PlcDtBO value)?  $default,){
final _that = this;
switch (_that) {
case _PlcDtBO() when $default != null:
return $default(_that);case _:
...
class _PlcDtBO implements PlcDtBO {
  ...
  factory _PlcDtBO.fromJson(Map<String, dynamic> json) => _$PlcDtBOFromJson(json);
...
@pragma('vm:prefer-inline')
_$PlcDtBOCopyWith<_PlcDtBO> get copyWith => __$PlcDtBOCopyWithImpl<_PlcDtBO>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PlcDtBOToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlcDtBO&&(identical(other.value, value) || other.value == value)&&(identical(other.dt, dt) || other.dt == dt));
}
...
abstract mixin class _$PlcDtBOCopyWith<$Res> implements $PlcDtBOCopyWith<$Res> {
  factory _$PlcDtBOCopyWith(_PlcDtBO value, $Res Function(_PlcDtBO) _then) = __$PlcDtBOCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'val') double value, String dt
});
...
/// @nodoc
class __$PlcDtBOCopyWithImpl<$Res>
    implements _$PlcDtBOCopyWith<$Res> {
