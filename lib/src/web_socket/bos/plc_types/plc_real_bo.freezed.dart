...
mixin _$PlcRealBO {
  ...
  $PlcRealBOCopyWith<PlcRealBO> get copyWith =>
      _$PlcRealBOCopyWithImpl<PlcRealBO>(this as PlcRealBO, _$identity);
...
abstract mixin class $PlcRealBOCopyWith<$Res> {
  factory $PlcRealBOCopyWith(PlcRealBO value, $Res Function(PlcRealBO) _then) =
      _$PlcRealBOCopyWithImpl;
  @useResult
  $Res call({@JsonKey(name: 'val') double value, String dt});
}

/// @nodoc
class _$PlcRealBOCopyWithImpl<$Res> implements $PlcRealBOCopyWith<$Res> {
...
extension PlcRealBOPatterns on PlcRealBO {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PlcRealBO value)? $default, {
...
class _PlcRealBO implements PlcRealBO {
  const _PlcRealBO(
      {@JsonKey(name: 'val') required this.value, this.dt = 'REAL'});
  factory _PlcRealBO.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PlcRealBOCopyWith<_PlcRealBO> get copyWith =>
      __$PlcRealBOCopyWithImpl<_PlcRealBO>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PlcRealBOToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PlcRealBOCopyWith<$Res>
    implements $PlcRealBOCopyWith<$Res> {
  factory _$PlcRealBOCopyWith(
          _PlcRealBO value, $Res Function(_PlcRealBO) _then) =
      __$PlcRealBOCopyWithImpl;
  @override
  @useResult
  $Res call({@JsonKey(name: 'val') double value, String dt});
}
...
/// @nodoc
class __$PlcRealBOCopyWithImpl<$Res> implements _$PlcRealBOCopyWith<$Res> {
