...
mixin _$WsMessageItemBO {
  ...
  $WsMessageItemBOCopyWith<WsMessageItemBO> get copyWith =>
      _$WsMessageItemBOCopyWithImpl<WsMessageItemBO>(
          this as WsMessageItemBO, _$identity);
...
abstract mixin class $WsMessageItemBOCopyWith<$Res> {
  factory $WsMessageItemBOCopyWith(
          WsMessageItemBO value, $Res Function(WsMessageItemBO) _then) =
      _$WsMessageItemBOCopyWithImpl;
  @useResult
  $Res call({String id, @JsonKey(name: 'props') Map<String, dynamic> value});
}
...
extension WsMessageItemBOPatterns on WsMessageItemBO {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WsMessageItemBO value)? $default, {
...
class _WsMessageItemBO implements WsMessageItemBO {
  const _WsMessageItemBO(
      {required this.id,
      @JsonKey(name: 'props') required final Map<String, dynamic> value})
      : _value = value;
  factory _WsMessageItemBO.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WsMessageItemBOCopyWith<_WsMessageItemBO> get copyWith =>
      __$WsMessageItemBOCopyWithImpl<_WsMessageItemBO>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$WsMessageItemBOToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$WsMessageItemBOCopyWith<$Res>
    implements $WsMessageItemBOCopyWith<$Res> {
  factory _$WsMessageItemBOCopyWith(
          _WsMessageItemBO value, $Res Function(_WsMessageItemBO) _then) =
      __$WsMessageItemBOCopyWithImpl;
  @override
  @useResult
  $Res call({String id, @JsonKey(name: 'props') Map<String, dynamic> value});
}
