...
/// Used to detect changes without downloading the entire file.
 String get md5Hash;/// User ID who owns this cache entry.
 String get userId;/// Timestamp when the cache was created.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CacheMetadata&&(identical(other.md5Hash, md5Hash) || other.md5Hash == md5Hash)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.cachedAt, cachedAt) || other.cachedAt == cachedAt));
}
...
@useResult
$Res call({
 String md5Hash, String userId, DateTime cachedAt
});
...
/// Create a copy of CacheMetadata
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? md5Hash = null,Object? userId = null,Object? cachedAt = null,}) {
  return _then(_self.copyWith(
md5Hash: null == md5Hash ? _self.md5Hash : md5Hash // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String md5Hash,  String userId,  DateTime cachedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CacheMetadata() when $default != null:
return $default(_that.md5Hash,_that.userId,_that.cachedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String md5Hash,  String userId,  DateTime cachedAt)  $default,) {final _that = this;
switch (_that) {
case _CacheMetadata():
return $default(_that.md5Hash,_that.userId,_that.cachedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String md5Hash,  String userId,  DateTime cachedAt)?  $default,) {final _that = this;
switch (_that) {
case _CacheMetadata() when $default != null:
return $default(_that.md5Hash,_that.userId,_that.cachedAt);case _:
  return null;
...
class _CacheMetadata implements CacheMetadata {
  const _CacheMetadata({required this.md5Hash, required this.userId, required this.cachedAt});
  factory _CacheMetadata.fromJson(Map<String, dynamic> json) => _$CacheMetadataFromJson(json);

/// MD5 hash of the config file from Firebase Storage.
///
/// Used to detect changes without downloading the entire file.
@override final  String md5Hash;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CacheMetadata&&(identical(other.md5Hash, md5Hash) || other.md5Hash == md5Hash)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.cachedAt, cachedAt) || other.cachedAt == cachedAt));
}
...
/// Create a copy of CacheMetadata
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? md5Hash = null,Object? userId = null,Object? cachedAt = null,}) {
