...
mixin _$UserPlcIdentifiers {
  ...
  $UserPlcIdentifiersCopyWith<UserPlcIdentifiers> get copyWith =>
      _$UserPlcIdentifiersCopyWithImpl<UserPlcIdentifiers>(
          this as UserPlcIdentifiers, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, userId,
      const DeepCollectionEquality().hash(identifiers), cachedAt);
...
abstract mixin class $UserPlcIdentifiersCopyWith<$Res> {
  factory $UserPlcIdentifiersCopyWith(
          UserPlcIdentifiers value, $Res Function(UserPlcIdentifiers) _then) =
      _$UserPlcIdentifiersCopyWithImpl;
  @useResult
  $Res call({String userId, List<String> identifiers, DateTime cachedAt});
}
...
extension UserPlcIdentifiersPatterns on UserPlcIdentifiers {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UserPlcIdentifiers value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UserPlcIdentifiers() when $default != null:
        return $default(_that.userId, _that.identifiers, _that.cachedAt);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String userId, List<String> identifiers, DateTime cachedAt)
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
class _UserPlcIdentifiers implements UserPlcIdentifiers {
  const _UserPlcIdentifiers(
      {required this.userId,
      required final List<String> identifiers,
      required this.cachedAt})
      : _identifiers = identifiers;
  factory _UserPlcIdentifiers.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UserPlcIdentifiersCopyWith<_UserPlcIdentifiers> get copyWith =>
      __$UserPlcIdentifiersCopyWithImpl<_UserPlcIdentifiers>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UserPlcIdentifiersToJson(
      this,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, userId,
      const DeepCollectionEquality().hash(_identifiers), cachedAt);
...
/// @nodoc
abstract mixin class _$UserPlcIdentifiersCopyWith<$Res>
    implements $UserPlcIdentifiersCopyWith<$Res> {
  factory _$UserPlcIdentifiersCopyWith(
          _UserPlcIdentifiers value, $Res Function(_UserPlcIdentifiers) _then) =
      __$UserPlcIdentifiersCopyWithImpl;
  @override
  @useResult
  $Res call({String userId, List<String> identifiers, DateTime cachedAt});
}
